...
$("#cell_phone, #home_phone").focus(function(){
		...
		$("#text_message_box").html('<select style="float:left;" class="form-control half_size" name="text_message_yes"><option value="Yes">Yes</option><option value="No">No</option></select><img src="http://www.erieit.edu/newsite/CI_eit_website/assets/images/help.png" id="help_button" style="float:left; margin-left:10px;"/> '),
...
$("#submit_application").click(function(){
	$.post( "http://www.erieit.edu/newsite/CI_eit_website/assets/includes/mailer.php", $( "#final" ).serialize() )
		.done(function(data) {
			$("#final").html(data)
		});
	$("#final").html('<img src="http://www.erieit.edu/newsite/CI_eit_website/assets/images/loading.gif" /> Sending ...');
})
/*
...
sticky JS - keeps side from in view when scrolling
...
sticky JS - keeps side from in view when scrolling END
...
/*
$('.icon_row').waypoint(function(direction) {
  if(direction == 'down'){
	  alert('waypoint worked');
	  
	  $('.computer_icon').fadeIn()

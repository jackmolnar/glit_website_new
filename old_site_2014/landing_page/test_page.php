...
<img src="images/welding_slider/img1.jpg" title="Does Training For a Career In Welding Spark Your Interest?" />
<img src="images/welding_slider/img2.jpg" title="Train in 1 of 15 Modern Welding Booths Using Lincoln Electric Equipment"/>
<img src="images/welding_slider/img3.jpg" title="EIT has an Impressive 12,000 Sq. Ft. Manufacturing Lab."/>
<img src="images/welding_slider/img4.jpg" title="EIT is Conveniently Located at the Millcreek Mall Complex for Easy Commuting."/>
</div>
...

{
			...
			if($mail->send(array(/*'info@glit.edu',  'ashleyd@glit.edu',*/ 'jonm@glit.edu'), 'mail')){
...
//<form name='form_step_1' id='form_step_1' action='step two/index2.php' method='post'>
		...
		print "
			...
			<form action='' method='post' name='final' id='final'"; ?>  <? print " >
...
<td align='left' style='font-size:10px; color:#666;'>
					...
					Erie Institute of Technology respects your privacy. EIT will never share your personal information with third parties.
						...
						<input " ?>  <? print "type='submit' name='submit_application' value='   ' id='submit_button' />
...
<div id="right_side">
<span style="font-size:18px; font-weight:bold; color:#039; line-height:25px; ">Find out how EIT can help you take the first step torward a career in Welding!</span>
  <br />
  <br />
  ...
  <li>Get hands-on training in 1 of our 15 welding booths</li>
      ...
      EIT is dedicated to developing the individual abilities of each student by providing them with the necessary skills and supporting knowledge to meet the job-entry level requirements in the field of welding, as well as computers, electronics, and manufacturing. </p>

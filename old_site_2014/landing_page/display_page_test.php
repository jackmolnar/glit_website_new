...
function clickclear (defaulttext)
{
...

{
	...
	if($mail->send(array('jonm@glit.edu', 'info@glit.edu', 'info@erieit.edu', 'nicoles@erieit.edu'), 'mail')){
...
<td align='left' style='font-size:10px; color:#666;'>
					...
					Erie Institute of Technology respects your privacy. EIT will never share your personal information with third parties.
						...
						<input type='submit' name='submit_application' value='   ' id='submit_button' />

...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><? echo $cfg->site_title; ?> | Program Overview</title>
...
?></ul>
					...
					<td id="rightcontent">
						<h2>Programs</h2>
<hr />
<p>EIT offers a wide range of training for&nbsp;technical careers. Our programs provide thorough, focused coverage of topics related to your chosen career, preparing you for the job market.&nbsp; And even better, there are no astronomy, chemistry or philosophy courses!</p>
					</td>
				</tr>
			</table><br clear="all" />

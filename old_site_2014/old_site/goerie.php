...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<meta name="keywords" content="erie, erie technology, erie job, computer training school, electronics training school, advanced manufacturing training school, Pennsylvania, Ohio, New York, computer training academy, computer training institute, electronic engineering technology, electronics technician training, biomedical equipment technician, Microsoft IT Academy, multimedia graphic design, web design, 3d animation, Maya, video game design, computer network, network security, database, Cisco technician, industrial automation, PLC, programmable logic control, robotics,  CNC, machining, manufacturing, maintenance, machinist, refrigeration, HVAC, RHVAC, air conditioning, welding, MIG, TIG, cutting torch, plasma cutting, pipe welding, metal fabrication" />

		<meta name="description" content="description" content="EIT is a computer, electronics and technical training school educating students from Pennsylvania, New York and Ohio."/>
...
?></ul>
				...
				<div class="hpod">
					...
					Toll-free: (866) 868-ERIE (3734)<br /><br />

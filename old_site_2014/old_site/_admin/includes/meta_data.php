...
$url = (!empty($_SERVER['HTTPS'])) ? "https://".$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'] : "http://".$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'];
	...
	if($url == 'http://erieit.edu/programs/computers/multimedia%20graphic%20design/'){
	...
	if($url == 'http://erieit.edu/programs/computers/network%20database%20professional/'){
	...
	if($url == 'http://erieit.edu/programs/computers/business%20office%20professional/'){
	...
	if($url == 'http://erieit.edu/programs/electronics/computer%20electronics%20engineering%20technology/'){
	...
	if($url == 'http://erieit.edu/programs/electronics/biomedical%20equipment%20technology/'){
	...
	if($url == 'http://erieit.edu/programs/electronics/electronic%20technician/'){
	...
	if($url == 'http://erieit.edu/programs/electronics/industrial%20automation%20robotics%20technology/'){
	...
	if($url == 'http://erieit.edu/programs/manufacturing/cnc%20machinist%20technician/'){
	...
	if($url == 'http://erieit.edu/programs/manufacturing/maintenance%20technician/'){
	...
	if($url == 'http://erieit.edu/programs/manufacturing/rhvac%20technology/'){
		...
		if($url == 'http://erieit.edu/programs/manufacturing/welding%20technology/'){
	...
	if($url == 'http://erieit.edu/programs/manufacturing/electrician/'){
	...
	if($url == 'http://erieit.edu/programs/computers/'){
	...
	if($url == 'http://erieit.edu/programs/electronics/'){
	...
	if($url == 'http://erieit.edu/programs/manufacturing/'){
	...
	if($url == 'http://erieit.edu/programs/continuing%20education/'){

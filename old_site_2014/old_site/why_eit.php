...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title><? echo $cfg->site_title; ?> | Why Eit?</title>
...
<h3>is an educational facility providing training for the technological careers of tomorrow.</h3>

<p>Whether you're just starting out in the world of technology or looking to expand your career opportunities, EIT is committed to helping you achieve your goals.<br />
...
<p>Conveniently located in Erie, PA, EIT is an easy commute for students from Pennsylvania, New York, and Ohio. We provide a wide variety of services to our students. Consider these unique EIT benefits:</p>
...
<h2>EIT: Erie's Manufacturing Technology School</h2>

<p>Bridgeport machine in advanced manufacturing lab</p>

<p>When the Center for Advanced Manufacturing &amp; Technology (CAMtech) closed it's doors several years ago, a void developed for industrial training. EIT -- Erie's Techology School -- stepped up to the forefront to continue providing this training in Erie County and the surrounding region. In fact, the training never really stopped ... we've trained over 900 students in our classrooms and at employers' sites. Now the new building is done and the machines are being readied for the next group of students. We've improved the former CAMtech programs based upon the needs of Erie employers and have what it takes to get you into the job market.</p>

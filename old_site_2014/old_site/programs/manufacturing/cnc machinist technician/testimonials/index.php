...
?></ul>
    ...
    <tbody>
        <tr>
            ...
            <h3>Machinist <br />
            Composiflex</h3>
            <p>The education I received from EIT helped me further my career in the machining field.</p>
            </td>
            <td><img src="http://erieit.edu/_images/testimonials/john_steen.jpg" alt="John Steen" /></td>
        </tr>
        <tr>
            <td><!--[if gte mso 9]><xml>
            <w:WordDocument>
            ...
            <![endif]-->
            <h2>Richard Welton</h2>
            <h3>CNC Supervisor<br />
            Composiflex</h3>
            <p class="MsoNormal"><br />
            In today&rsquo;s advancing technology in the CNC Machining field it is a real asset to have a school like EIT to provide us with skilled entry level machinists.</p>
            </td>
            <td><img src="http://erieit.edu/_images/testimonials/richard_welton.jpg" alt="Richard Welton" /></td>
        </tr>
        <tr>
            <td><!--[if gte mso 9]><xml>
            <w:WordDocument>
            ...
            <![endif]-->
            <h2>Cheryl Murray</h2>
            <h3>Human Resources Administrator<br />
            Electric Materials</h3>
            <p class="MsoNormal"><br />
            <span style="font-size: 10pt; font-family: Arial;">When it comes time to hire we always consider EIT graduates.</span></p>
            </td>
            <td><img src="http://erieit.edu/_images/testimonials/cheryl_murray.jpg" alt="Cheryl Murray" /></td>
        </tr>
    </tbody>
</table>
<br />

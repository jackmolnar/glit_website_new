...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><? echo $cfg->site_title; ?> | Manufacturing Technician</title>
...
?></ul>
					...
					<img src="http://www.erieit.edu/_files/images/file_49.jpg" style="border: 3px solid rgb(234, 234, 234); margin: 5px; float: right;" alt="Manufacturing Technician" />
<h2>Manufacturing Technician</h2>
<h3>Overview</h3>
<hr />
<p>It&rsquo;s almost like something out of a science fiction movie &hellip; place a chunk of metal in a machine, push some buttons, then removed a finished manufactured piece!&nbsp; The growing availability and use of technology, such as computer-aided design and computer-aided manufacturing continues to increase the need for trained technicians in manufacturing.</p>
<p>Begin your training with the basics of metalworking in a real-life manufacturing environment, then move ahead into advanced industrial production technologies, computer-aided design (CAD), and computer-aided machining (CAM), as well as the programming and operation of computer numerical controlled machines (CNC).</p>
				</td>
</tr>
			</table>
		<br clear="all" />

...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><? echo $cfg->site_title; ?> | Moldmaker Mold Designer</title>
...
<tr>
	...
	//if($common->checkurlForPageName("moldmaker%20mold%20designer")){
		//print "<li><div class='leftselect'>Moldmaker Mold Designer</div></li>";
	//}else{
		//print "<li><a href='".$depth."programs/manufacturing/moldmaker mold designer/'>Moldmaker Mold Designer</a></li>";
	//}
	//if($common->checkurlForPageName("manufacturing%20technician")){
		//print "<li><div class='leftselect'>Manufacturing Technician</div></li>";
	//}else{
		//print "<li><a href='".$depth."programs/manufacturing/manufacturing technician/'>Manufacturing Technician</a></li>";
	//}
	...
	if($common->checkurlForPageName("welding technology")){
		print "<li><div class='leftselect'>Welding Technology</div></li>";
	}else{
		print "<li><a href='".$depth."programs/manufacturing/welding technology/'>Welding Technology</a></li>";
	}
?></ul>
    <br />
				</div>
...
?></ul>
					...
					<img alt="Moldmaker Mold Designer" style="border: 3px solid rgb(234, 234, 234); margin: 5px; float: right;" src="http://www.erieit.edu/_files/images/file_51.jpg" />
<h2>Moldmaker/Mold Designer</h2>
<h3>Overview</h3>
<hr />
<p>Precision to one ten-thousandth of an inch or greater &ndash; that&rsquo;s what you&rsquo;ll be working with.&nbsp; You can&rsquo;t make quality plastics products without quality molds and the plastics moldmaking industry is facing chronic shortages of skilled moldmakers. If you possess a high degree of patience and an eye for detail, get ready to take your place in this industry.</p>
<p>Moldmakers need a solid foundation for excellence, since they are the starting point in the supply chain of producing a quality end product.&nbsp; Gain hands-on skills in machining, assembling, and polishing for a career in designing and building molds.&nbsp; Your knowledge of metallurgy, technical math, and dimensioning will be applied directly to the operation of advanced CNC, EDM, and other computer-aided processes used in the moldmaking industry.</p>
				</td>
</tr>
			</table>
		<br clear="all" />

...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><? echo $cfg->site_title; ?> | Registration</title>
...
<h3>Enrollment</h3>
<hr />
<p>Advance registration is required for all classes, seminars, and workshops. Class size is limited and is available on a first-come first-served basis. Please register as early as possible to assure your participation.</p>
<br />
<h3>Registration</h3>
<hr />
<p>You may register for classes by:</p>
<ul>
    <li>MAIL: Mail to the address at the <a href="http://www.glit.edu/training/Locations.html">class location </a></li>
    <li>PHONE: Call between 8 AM &amp; 5 PM Monday thru Friday at the <a href="http://www.glit.edu/training/Locations.html">class location </a></li>
    <li>E-MAIL: Please provide all the information requested on this form and send to: <a href="mailto:mariew@erieit.edu?subject=Email%20from%20EIT%20Continuing%20Ed%20Registration%20page">MarieW@Erie.edu</a></li>
    <li>FAX: Complete the form and fax to the <a href="http://www.glit.edu/training/Locations.html">class location</a></li>
</ul>
<br />
<h3>Fees</h3>
<hr />
<h4>Fees may be paid by:</h4>
<ul>
    <li>Credit Card &ndash; provide information on the registration form; we accept MasterCard and Visa</li>
    <li>Check or Money Order &ndash; payable to &ldquo;Erie Institute of Technology&rdquo;</li>
    <li>Arrangements for invoicing must be made at the time of registration; please furnish a signed company P.O.</li>
</ul>
<br />
<h3>Confirmation</h3>
<hr />
<p>All registrations received at least 5 business days prior to the start of the class will be confirmed by mail or email. Others will be confirmed by telephone.</p>
<br />
<h3>Cancellation/Refunds</h3>
<hr />
<p>Any registration cancelled by a participant before 3 business days prior to the class start may receive a full refund or credit toward another class. Cancellations after 3 business days prior to the class start, or after the class has begun, will be invoiced; any fees paid will be retained, and no refunds will be given. You may substitute participants for paid registrations.</p>
<p>Erie&nbsp;Institute of Technology reserves the right to re-schedule or cancel any class. All class fees will be refunded or credited toward another class in this case.</p>
<br />
<h3>Directions &amp; Registration Forms</h3>
<hr />
<a href="http://www.glit.edu/training/Locations.html">For registration forms and directions to class locations</a>
				</div>				

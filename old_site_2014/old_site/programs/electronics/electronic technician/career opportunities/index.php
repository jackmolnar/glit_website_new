...
<ul>
    ...
    <li>Electronic Test Technician</li>
    <li>Customer Service Technician</li>
    <li>Cable Television Technician</li>
    <li>Communications Technician</li>
    <li>Electronic Equipment Repairer</li>
    <li>Electronic Equipment Installer</li>
    <li>Production Test Technician</li>
</ul>
				</td>
</tr>
			</table>

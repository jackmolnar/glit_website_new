...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title><? echo $cfg->site_title; ?> | Electronic Technician</title>
...
?></ul>
					...
					<img style="border-right: rgb(234,234,234) 3px solid; border-top: rgb(234,234,234) 3px solid; float: right; margin: 5px; border-left: rgb(234,234,234) 3px solid; border-bottom: rgb(234,234,234) 3px solid" alt="Erie Electronics Training" src="http://www.erieit.edu/_files/images/file_39.jpg" />
...
<p>Electronic devices make our high-tech world possible. However, the level of technical expertise needed to install, troubleshoot, and maintain this equipment has increased beyond the scope of the average individual.</p>

...
?></ul>
					...
					This program prepares the student for an entry-level position as an Electronics Technician, Electronics Test Technician, Electronics Installer, Slot Machine Technician, or Electronics Repairer.

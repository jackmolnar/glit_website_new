...
Full-time 96 week program</h4>
<p>122 Credits -- 2400 Hours</p>
<table width="400" cellspacing="1" cellpadding="1" border="0">
    <tbody>
        <tr>
            <td>
            <ul>
                <li>DC, AC, Active Components</li>
                <li>Circuit Design</li>
                <li>Digital Principles</li>
                <li>Microprocessors</li>
                <li>Industrial Electronics</li>
                <li>Algebra for Electronics</li>
                <li>PLC / Robotics</li>
            </ul>
            </td>
            <td>
            <ul>
                ...
                <li>Trig. for Electronics</li>
                <li>Computer Networking</li>
                <li>Computer Programming</li>
                <li>Electronic Drafting</li>

...
?></ul>
					...
					<p>The EIT Mechanical Systems Lab gives you hands-on training in mechanics, simple machines, levers, linkages, gear trains and systems, belt and chain drive systems, brakes, clutches, and friction devices. In the Office Machine Repair Lab, you&rsquo;ll learn troubleshooting practices, removal and replacement of faulty components, adjustments, and preventative maintenance procedures of various types of equipment, including photocopiers, FAX machines, laser printers, digital scanners, and word processors.</p>
<ul>
    <li>Office Machine Repairer</li>
    <li>Office Machine Service Technician</li>
    <li>Customer Service Technician</li>
    <li>Office Machine Installer</li>
    <li>Automated Teller Machine Technician</li>
    <li>Field Service Engineer</li>
    <li>Copier Service Technician</li>
</ul>
				</td>
</tr>
			</table>

...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><? echo $cfg->site_title; ?> | Office Machine Service Technology</title>
...
?></ul>
					...
					<h2>Program Objective<img class="" height="167" alt="" width="185" align="right" src="http://www.erieit.edu/_files/images/file_10.jpg" /></h2>
<p>Without a doubt you&rsquo;ve experienced problems with the office copier, printer, or fax machine &ndash; paper jams, out of toner, network problems.&nbsp;No wonder the Office Machine Service Technician is such a valuable person!</p>
<p>Digital copiers and other, newer office machines are costly and complex. This equipment often is computerized, designed to work on a network, and capable of performing multiple functions. Since repairs are usually done on-site, Field Technicians are needed to inspect, maintain, and repair office machines, such as copiers, adding and accounting machines, typewriters, printers, fax machines, cash registers, dictating machines, and postage meters, or more sophisticated equipment such as ATMs.</p>
				</td>
</tr>
			</table>
		<br clear="all" />

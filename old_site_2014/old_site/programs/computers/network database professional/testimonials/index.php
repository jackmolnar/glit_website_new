...
?></ul>
    ...
    <tbody>
        <tr>
            ...
            <![endif]-->
            <h2>Patrick Kilgallon</h2>
            <h3>Technology Service Manager<br />
            Erie Times-News<br />
            <br />
            <!--[if gte mso 9]><xml>
            <w:WordDocument>
            ...
            <![endif]--></h3>
            <p class="MsoNormal"><span style="font-size: 10pt; font-family: Arial;">Within the computer or electronics field there are numerous career choices a person can take after graduation. In filling any position I look for someone who has a fundamental knowledge of the skills needed. EIT students are getting the necessary training I need and when hired become more productive in a shorter timeframe.</span></p>
            </td>
            <td><img alt="" src="http://erieit.edu/_images/testimonials/patrick_kilgallon.jpg" /></td>
        </tr>
        <tr>
            <td><!--[if gte mso 9]><xml>
            <w:WordDocument>
            ...
            <![endif]-->
            <h2>Tom DelFratte</h2>
            <h3>Supervisor of Information Services<br />
            McDowell  School District</h3>
            <p class="MsoNormal"><span style="font-size: 10pt; font-family: Arial;">In my experience with EIT interns, I have found individuals that possess the skills, knowledge and professional qualities that would make them prime candidates for any job openings that I may have.</span></p>
            </td>
            <td><img alt="Tom Delfratte" src="http://erieit.edu/_images/testimonials/tom_delfratte.jpg" /></td>
        </tr>
        <tr>
            <td><!--[if gte mso 9]><xml>
            <w:WordDocument>
            ...
            <![endif]-->
            <h2>Joel C. Tuzynski</h2>
            <h3>Executive Director<br />
            Multicultural Community Resource  Center</h3>
            <p class="MsoNormal">We have had an excellent experience working with EIT. I encourage any business to consider hiring graduates from EIT as I&rsquo;m sure you will be very satisfied!</p>
            </td>
            <td><img alt="" src="http://erieit.edu/_images/testimonials/joel_c_tuzynski.jpg" /></td>
        </tr>
        <tr>
            <td><!--[if gte mso 9]><xml>
            <w:WordDocument>
            ...
            As a recent night time network and database administrator graduate I found the extra skills needed to change my career. The EIT instructors are the most qualified and knowledgeable in the Erie area. Without EIT I never would have imagined the enjoyment and satisfaction working in the IT field.</p>
            </td>
            <td><img alt="" src="http://erieit.edu/_images/testimonials/mike_tibbens.jpg" /></td>
        </tr>
    </tbody>
</table>
<br />

...
<h4>Associate in Specialized Technology Degree<br />
Full-time 72 week program</h4>
<p>83 Credits -- 1800 Hours</p>
<hr />
<table style="width: 443px; height: 117px" cellspacing="1" cellpadding="1" width="443" border="0">
    <tbody>
        <tr>
            <td>
            <ul>
                <li><i>Linux </i>Fundamentas &amp; Admin.</li>
                ...
                <li>Windows Script</li>
            </ul>
            </td>
            <td>
            <ul>
                <li>Hardware</li>
                <li>Router (<i>Cisco</i>) Technology</li>
                <li>Routing &amp; Switching</li>
                <li>Database Server</li>
                <li>Exchange Server</li>
                <li>Programming Database</li>

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Apply Online | Erie Institute of Technology</title>
...
<table width='800' border='0' cellspacing='0' cellpadding='0' id='program_info'>
  ...
  <tr>
	...
	if ($program_array == 'Biomedical Equipment Technology'){
	...
	if ($program_array == 'Business and Information Management'){
	...
	if ($program_array == 'CNC / Machinist Technician'){
    ...
    <td id='program_2' >Biomedical Equipment Technology <br/>Business and Information Management<br/>CNC / Machinist Technician<br/>Electrician</td>
	...
	if ($program_array == 'Electronic Engineering Technology'){
	...
	if ($program_array == 'Electronics Technician'){
	...
	if ($program_array == 'Industrial Automation & Robotics Technology'){
	...
	if ($program_array == 'Maintenance Technician'){
...
Maintenance Technician</td>
 ...
 <td id='program_5' ><table class='program_x' border='0' cellspacing='0' cellpadding='0' >
	...
	if ($program_array == 'Multimedia Graphic Design'){
	...
	if ($program_array == 'Network & Database Professional'){
	...
	if ($program_array == 'RHVAC Technology'){
	...
	if ($program_array == 'Welding Technology'){
...
if (isset($_COOKIE["reachlocal_display"])){
	$messageSubject = "Erie Institute of Technology - Online Application - ReachLocal Display - $first_name $last_name";
}elseif (isset($_COOKIE["reachlocal"])){
	$messageSubject = "Erie Institute of Technology - Online Application - ReachLocal - $first_name $last_name";
} else {
...
I authorize investigation of all statements contained in this application. I understand that misrepresentation or omission of facts called for is cause for rejection of this application or dismissal, if enrolled.<p><hr /></td>	
			...
			/******/
				...
				print "<tr>
						...
						<td colspan='2' align='right'><br/><input";?> onclick="track_apply_online();" <? print " type='submit' name='submit_application' value='Apply Now' id='input_button' /></td>

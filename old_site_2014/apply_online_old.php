...
<table width='800' border='0' cellspacing='0' cellpadding='0' id='program_info'>
  ...
  <tr>
    ...
    <td id='program_2' >Biomedical Equipment Technology <br/>Business Office Professional<br/>CNC / Machinist Technician<br/>Electrician</td>
...

{
	...
	if($mail->send(array('info@glit.edu', 'trishap@glit.edu'), 'mail')){

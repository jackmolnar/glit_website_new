	...
	<div style="width:814px; margin-left:auto; margin-right:auto;padding-left:0px; padding-right:0px;">
		...
		<div style="position:relative; z-index:710;">
			<div id="divPopUpContainer" style="display:none; position:absolute; left:130px; top:200px; z-index:710;">
				<div style="background-image:url(<?php echo $depth; ?>_<?php echo $depth; ?>_<?php echo $depth; ?>_images/ge_template/ge_template/popup_top.png); width:532px; height:27px;"></div>
				<div style="background-image:url(<?php echo $depth; ?>_<?php echo $depth; ?>_images/ge_template/ge_template/popup_repeater.png); background-repeat:repeat-y; width:532px;">
					...
					<div class="popup-close" style="float:right; margin-right:32px;"><a href="javascript:closePopUp()"><img src="<?php echo $depth; ?>_<?php echo $depth; ?>_images/ge_template/ge_template/popup_close.gif" alt="Close" title="Close" style="border-width:0px;" /></a></div>
					<div style="clear:both;"></div>
					<div id="divDotDivider" style="width:532px; margin-top:10px; margin-bottom:5px;"><img src="<?php echo $depth; ?>_<?php echo $depth; ?>_images/ge_template/ge_template/popup_dotdivider.png" alt="" title=""/> </div>
				...
				<div style="background-image:url(<?php echo $depth; ?>_<?php echo $depth; ?>_images/ge_template/ge_template/popup_bottom.png); width:532px; height:34px;"></div>			
			</div>
		</div>
		<!--pop up ended-->

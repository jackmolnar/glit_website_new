    <nav class="navbar navbar-inverse " role="navigation">
      <div class="container">
        <div class="navbar-header">
           <a class="navbar-brand" href="<?php echo site_url();?>"><img src="<?php echo base_url("assets/images/eit_logo.png");?>" /></a>
        </div>
	...
	<div class="right_content">
        ...
        <button type="button" class="btn btn-warning btn-sm" onclick="track_directions();"><span class="glyphicon glyphicon-map-marker"></span><span class="top_req_info_text">&nbsp;&nbsp;DIRECTIONS</span></button>
        </div>
		</div>
        <!-- req more info button -->
         ...
         <span class="glyphicon glyphicon-list"></span>
          ...
          <div class="mobile_nav">
          	<div class="btn-group btn-group-justified">
                ...
                <div class="btn-group">
                 <button type="button" class="btn btn-warning btn-sm call_button" onclick="track_phone_call();">
                 <span class="glyphicon glyphicon-earphone"></span><span class="call_button_text">CALL</span>
              	 </button>
                 </div>
                <div class="btn-group">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-warning btn-sm" onclick="track_directions();">
          ...
          <ul class="nav navbar-nav">
            <li class="dropdown">
              <a href="<?php echo base_url('training_programs'); ?>" class="dropdown-toggle" data-toggle="dropdown">PROGRAMS <b class="caret"></b></a>
        ...
        <li class="program_header">SKILLED TRADE PROGRAMS</li>
        <li><?php echo anchor("training_programs/auto_body_technician","AUTO BODY TECHNICIAN <span style='font-weight: bold;
margin-left: 10px;
color: #50CC5F;'>*NEW</span>");?></li> 
        ...
        <li><?php echo anchor("training_programs/welding_technology", "WELDING TECHNOLOGY");?></li>
            ...
            <li class="dropdown" ><a href="<?php echo base_url('admissions'); ?>" class="dropdown-toggle" data-toggle="dropdown">ADMISSIONS<b class="caret"></b></a>
			      <ul class="dropdown-menu">
            ...
            <li class="dropdown">
              <a href="<?php echo base_url('about_eit'); ?>" class="dropdown-toggle" data-toggle="dropdown">ABOUT EIT<b class="caret"></b></a>
              <ul class="dropdown-menu">
                ...
                <li><?php echo anchor("student_handbook","STUDENT HANDBOOK");?></li>
              </ul>
            </li>
            
            <li ><?php echo anchor("http://eit-continuinged.com/","CONTINUING ED");?></li> 

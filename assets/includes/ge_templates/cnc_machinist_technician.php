<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	<script type="text/javascript">
        ...
        var dict = [];
        dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'] = {};
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].opeId='022039';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].schoolName='Erie Institute of Technology';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].currentYear='2014';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].prevYear='2013';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].programName='Machine Tool Technology/Machinist';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].customProgramName='CNC/ Mechanist Technician';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].cipCode='48.0501';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].awardLevel='Undergraduate certificate';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].tutionAndFees='20100';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].booksAndSupplies='2025';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].roomAndBoard='0';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].roomAndBoardNotOffered=true;
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].additionalFeeAndExpenses='No additional information provided.';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].urlForProgramCost='http://www.erieit.edu';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].numberOfStudentsCompletedProgram='25';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].numberOfStudentsCompletedProgramWithDebt='0';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].isLessThanTenGraduatesReceivedLoan=false;
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].title4MedianDebt='8380';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].privateMedianDebt='0';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].financingPlanDebt='0';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].normalTimeToCompleteProgram='12';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].durationTypeInWeeksMonthsYears='months';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].numberOfStudentsCompletedProgramInNormalTime='25';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].jobPlacementRateIsPrivate=false;
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].reportedToAgency=true;
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].jobPlacementRateForAgency='89';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].agencyToReport='Accrediting Commission of Career Schools and Colleges';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].completedStudentsIncludedForAgency='All students that started between 10/11 - 09/12';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].jobTypesForAgency='fieldrelated';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].positionsRecentCompletersHiredForAgency='Toolmaker, CNC - Machinist/ Operator, Programmer';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].formerStudentsEmploymentTimeForAgency='Within 180 days of completion';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].trackingMethodForAgency='3';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].trackingValueForAgency='Career Services Department ';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].additionalNotes='No additional information provided.';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].dateCreated='12/30/2014';
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations=[];
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Extruding and Drawing Machine Setters, Operators, and Tenders, Metal and Plastic', oneCode: '51-4021.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Forging Machine Setters, Operators, and Tenders, Metal and Plastic', oneCode: '51-4022.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Rolling Machine Setters, Operators, and Tenders, Metal and Plastic', oneCode: '51-4023.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Cutting, Punching, and Press Machine Setters, Operators, and Tenders, Metal and Plastic', oneCode: '51-4031.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Drilling and Boring Machine Tool Setters, Operators, and Tenders, Metal and Plastic', oneCode: '51-4032.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Grinding, Lapping, Polishing, and Buffing Machine Tool Setters, Operators, and Tenders, Metal and Plastic', oneCode: '51-4033.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Lathe and Turning Machine Tool Setters, Operators, and Tenders, Metal and Plastic', oneCode: '51-4034.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Milling and Planing Machine Setters, Operators, and Tenders, Metal and Plastic', oneCode: '51-4035.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Machinists', oneCode: '51-4041.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Multiple Machine Tool Setters, Operators, and Tenders, Metal and Plastic', oneCode: '51-4081.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Heat Treating Equipment Setters, Operators, and Tenders, Metal and Plastic', oneCode: '51-4191.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Layout Workers, Metal and Plastic', oneCode: '51-4192.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].relatedOccupations.push({ oneTitle: 'Metal Workers and Plastic Workers, All Other', oneCode: '51-4199.00' });
dict['ef9d3f3c-dcf6-43d8-915b-5d6b7886122c'].otherInstitutions=[];
...
<body style="margin:0pt; background-color:White;">
	...
	<script type="text/javascript">
		...
		displayTemplate('ef9d3f3c-dcf6-43d8-915b-5d6b7886122c');
    </script>    

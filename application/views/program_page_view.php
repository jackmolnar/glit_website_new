...
<div class="container">
    ...
    <div class="col-sm-4 col-md-4">
    		...
    		<!-- if new program -->
    		<?php if($new_program == 1) echo "<h2 class='new_program'>* NEW PROGRAM!</h2>"; ?>
            <!-- end if new program -->
    ...
    <div class="container">
  	...
  	<hr>
        ...
        <div class="col-md-4 side_form_column">
          ...
          <div class="side_form "><?php
		  
		  //testing side form with CNC page
		  		  
		  if($slug == 'cnc_machinist_technician_test'){
		  	include('assets/includes/side_form_test.php'); 
		  } else {
			include('assets/includes/side_form.php'); 
		  }
